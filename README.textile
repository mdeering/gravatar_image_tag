...
h2. This repo will be properly renamed to gravatar_image_tag once the GitHub Rackspace move is done this weekend and they turn back on renaming.

_I really can not believe that I consistently spelled the name wrong through this whole process_

!http://s.gravatar.com/images/logo.png(Gravitar Logo)!

h1. Gravitar Image Tag Plugin
...
The traditional way.
<pre>./script/plugin install git://github.com/mdeering/gravatar_helper.git</pre>

or the old-school but still c00l way!
<pre>piston import git://github.com/mdeering/gravatar_helper.git vendor/plugins/gravatar_helper</pre>

or for all you hip gitsters.
<pre>git submodule add git://github.com/mdeering/gravatar_helper.git vendor/plugins/gravatar_helper git submodule init</pre>
...
<pre>gravatar_image_tag('junk', :alt => 'Default Gravitar Image')</pre>

*Splat* the default gravatar image !http://www.gravatar.com/avatar.php?gravatar_id=0c821f675f132d790b3f25e79da739a7(Default Gravitar Image)!
...
<pre>gravatar_image_tag('junk', :alt => 'Github Default Gravitar', :gravatar => { :default => 'http://github.com/images/gravatars/gravatar-80.png' })</pre>
...
The ideas an methods for this plugin are from expanding upon my original blog post "Adding Gravitar To Your Website Or Blog (Gravitar Rails)":http://mdeering.com/posts/005-adding-gravatar-to-your-website-or-blog
